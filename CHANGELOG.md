...
- 👷🏻 Test framework moved to Node.js test runner, by [@compulim](https://github.com/compulim) in PR [#26](https://github.com/compulim/use-schema-org-action/pull/26)

## [0.1.1] - 2025-12-24

### Changed

- Bumped dependencies, in PR [#23](https://github.com/compulim/use-schema-org-action/pull/23)
  - Production dependencies
    - [`iter-fest@0.3.1`](https://npmjs.com/package/iter-fest/v/0.3.1)
  ...
  - Development dependencies
    ...
    - [`@happy-dom/jest-environment@20.0.11`](https://npmjs.com/package/@happy-dom/jest-environment/v/20.0.11)
    ...
    - [`msw@2.12.4`](https://npmjs.com/package/msw/v/2.12.4)
...
[Unreleased]: https://github.com/compulim/use-schema-org-action/compare/v0.1.1...HEAD
[0.1.1]: https://github.com/compulim/use-schema-org-action/compare/v0.1.0...v0.1.1
